...
namespace Sonic853.Udon.CnLunar
{
    public class Config : UdonSharpBehaviour
    {
        ...
        // body.Add(bad);
        // dic.Add("建", body);
        public DataDictionary OfficerThings = new DataDictionary()
        {
            {
                "建", new DataList() {
                    new DataList() {
        ...
        public DataDictionary BadGodDic = new DataDictionary() {
            {
                "平日", new DataList() {
                    new DataList() {
                        "亥",
        ...
        public DataList LevelList = new DataList() {
            "上：吉足胜凶，从宜不从忌。",
        ...
        public DataList ThingLevelList = new DataList() {
            "从宜不从忌",
            "从宜亦从忌",
            "从忌不从宜",
            "诸事皆忌",
        ...
        public DataList MrY13List = new DataList() {
            new DataList() { 1, 13 },
            new DataList() { 2, 11 },
            new DataList() { 3, 9 },
            new DataList() { 4, 7 },
        ...
        DataDictionary angel = new DataDictionary(){
            {
                "岁德", new DataList() {
                    "",
                    "",
        ...
        )
        {
            ...
            angel["大葬"].DataList[1] = "壬申癸酉壬午甲申乙酉丙申丁酉壬寅丙午己酉庚申辛酉";
            //             new DataList() {
            //                 "安葬"
            //             },
            //             new DataList() { }
            ...
            angel["鸣吠"].DataList[1] = "庚午壬申癸酉壬午甲申乙酉己酉丙申丁酉壬寅丙午庚寅庚申辛酉";
            //             new DataList() {
            //                 "破土", "安葬"
            //             },
            //             new DataList() { }
            ...
            angel["小葬"].DataList[1] = "庚午壬辰甲辰乙巳甲寅丙辰庚寅";
            //             new DataList() {
            //                 "安葬"
            //             },
            //             new DataList() { }
            ...
            angel["鸣吠对"].DataList[1] = "丙寅丁卯丙子辛卯甲午庚子癸卯壬子甲寅乙卯";
            //             new DataList() {
            //                 "破土", "启攒"
            //             },
            //             new DataList() { }
            ...
            angel["不守塚"].DataList[1] = "庚午辛未壬申癸酉戊寅己卯壬午癸未甲申乙酉丁未甲午乙未丙申丁酉壬寅癸卯丙午戊申己酉庚申辛酉";
            //             new DataList() {
            //                 "破土"
            //             },
            //             new DataList() { }
        ...
        DataDictionary demon = new DataDictionary() {
            {
                "岁破", new DataList() {
                    "",
                    true,
        ...
        )
        {
            ...
            var 土王用事time = (new DateTime(nextSolarTermYear, twys[0], twys[1]) - date).Days;
            //     {
            //         "岁破", new DataList() {
            //             den == (yen + 6) % 12,
            //             true,
            demon["岁破"].DataList[0] = den == (yen + 6) % 12;
            demon["岁破"].DataList[1] = true;
            //             new DataList() { },
            //             new DataList() { "修造", "搬移", "嫁娶", "出行" }
            //         }
            //     },
            ...
            // demon["杨公忌"].DataList[1] = MrY13List;
            //             new DataList() { },
            //             new DataList() {
            //                 "开张", "修造", "嫁娶", "立券"
            //             }
            ...
            //         "地囊", new DataList() {
            //             d,
            //             new string[] { "辛未辛酉", "乙酉乙未", "庚子庚午", "癸未癸丑", "甲子甲寅", "己卯己丑", "戊辰戊午", "癸未癸巳", "丙寅丙申", "丁卯丁巳", "戊辰戊子", "庚戌庚子"}[men],
            ...
            //         "八风触水龙", new DataList() {
            //             d,
            //             new string[] { "丁丑己酉", "甲申甲辰", "辛未丁未", "甲戌甲寅" }[sn],
            ...
            //         "阴错", new DataList() {
            //             // "壬子癸丑庚寅辛卯庚辰丁巳丙午丁未甲申乙酉甲戌癸亥"[men * 2:men * 2 + 2]
            //             "壬子癸丑庚寅辛卯庚辰丁巳丙午丁未甲申乙酉甲戌癸亥".Substring(men * 2, 2),
            //             d,
            ...
            //         "四废", new DataList() {
            //             d,
            //             new string[] { "庚申辛酉", "壬子癸亥", "甲寅乙卯", "丁巳丙午" }[sn],
            ...
            //     {
            //         "五墓", new DataList() {
            //             new string[] { "壬辰", "戊辰", "乙未", "乙未", "戊辰", "丙戌", "丙戌", "戊辰", "辛丑", "辛丑", "戊辰", "壬辰" }[men],
            //             d,
            ...
            // demon["岁薄"].DataList[0].DataList.Add(lmn);
            // demon["岁薄"].DataList[0].DataList.Add(d);
            //             // [(4, "戊午"), (4, "丙午"), (10, "壬子"), (10, "戊子")]
            //             new DataList() {
            //                 new DataList() { 4, "戊午" },
            //                 new DataList() { 4, "丙午" },
            ...
            // demon["逐阵"].DataList[0].DataList.Add(lmn);
            // demon["逐阵"].DataList[0].DataList.Add(d);
            //             // [(6, "戊午"), (6, "丙午"), (12, "壬子"), (12, "戊子")]
            //             new DataList() {
            //                 new DataList() { 6, "戊午" },
            //                 new DataList() { 6, "丙午" },
            ...
            // demon["阴阳交破"].DataList[0].DataList.Add(lmn);
            // demon["阴阳交破"].DataList[0].DataList.Add(d);
            //             // [(10, "丁巳")]
            //             new DataList() {
            //                 new DataList() { 10, "丁巳" }
            //             },
        ...
        public DataDictionary Day8CharThing = new DataDictionary() {
            {
                "甲", new DataList() {
                    new DataList() { },
                    new DataList() {
